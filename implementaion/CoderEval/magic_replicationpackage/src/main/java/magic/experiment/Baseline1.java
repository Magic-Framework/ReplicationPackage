...
public class Baseline1 {
    ...
    private static final String outputFile = "magic_replicationpackage/src/main/resources/codereval/baseline1/deepseek-baseline1-gpt-java.jsonl";
    private static final String outputFile2 = "magic_replicationpackage/src/main/resources/codereval/baseline1/gpt-5-baseline1-gpt-java.jsonl";
    private static final String outputFile3 = "magic_replicationpackage/src/main/resources/codereval/baseline1/deepseek-baseline1-gpt-python.jsonl";
    private static final String outputFile4 = "magic_replicationpackage/src/main/resources/codereval/baseline1/gpt-5-baseline1-gpt-python.jsonl";
    ...
    public static void a() throws Exception {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(outputFile, true))) {
            for (GenerateCode4CoderEval entry : generateCodes) {
                ...
                improvedCode = baseline1Agent.fixJavaIssue(improvedCode, violations, startLine);
    ...
    public static void c() throws Exception {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(outputFile3, true))) {
            for (GenerateCode4CoderEval entry : generateCodes) {
                ...
                improvedCode = baseline1Agent.fixPythonIssue(improvedCode, violations, startLine);
                long endTime = System.nanoTime();
