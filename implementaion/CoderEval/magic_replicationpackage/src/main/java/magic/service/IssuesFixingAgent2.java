...
public class IssuesFixingAgent2 {
    ...
    public String fixJavaIssue(String code, List<CodeViolation> codeViolations, int startLine) throws Exception {
        ...
        for (CodeViolation codeViolation : codeViolations) {
            ...
            rules.append("IssueType:").append(rule.getRuleName()).append("\n");
            ...
            rules.append("RefactoringExample:").append("\n");
    ...
    public String fixPythonIssue(String code, List<CodeViolation> codeViolations, int startLine) throws IOException {
        PromptTemplate template = PromptTemplate.from(
                """
